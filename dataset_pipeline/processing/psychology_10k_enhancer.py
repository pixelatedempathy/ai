...
class Psychology10kEnhancer:
    ...
    def __init__(
        self,
        knowledge_base_path: str = "ai/pixel/knowledge/enhanced_psychology_knowledge_base.json",
    ...
    def enhance(self, output_path: str = "ai/pixel/knowledge/further_enhanced_psychology_knowledge_base.json") -> None:
...
def main():
    ...
    parser.add_argument(
        "--output-path",
        default="ai/pixel/knowledge/further_enhanced_psychology_knowledge_base.json",
