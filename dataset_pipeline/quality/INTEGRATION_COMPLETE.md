...
- `ai/dataset_pipeline/quality/quality_scoring_v1.py` - Pipeline adapter
- `ai/dataset_pipeline/quality/quality_filter_v1.py` - Standalone filter
- `ai/dataset_pipeline/quality/INTEGRATION_GUIDE.md` - Usage guide
- `ai/dataset_pipeline/orchestration/pipeline_orchestrator.py` - Main orchestrator
- `ai/dataset_pipeline/unified_preprocessing_pipeline.py` - Preprocessing pipeline
