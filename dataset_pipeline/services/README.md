...
```python
from ai.dataset_pipeline.services.provenance_pipeline_integration import (
    ProvenanceTracker,
...
python -m ai.dataset_pipeline.cli.provenance_cli get --dataset-id my_dataset
...
# View audit log
python -m ai.dataset_pipeline.cli.provenance_cli audit-log \
    --dataset-id my_dataset \
    --limit 50
```
