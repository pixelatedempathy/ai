...
**Location**: `ai/pipelines/edge_case_pipeline_standalone/output/edge_cases_training_format.jsonl`
...
**Location**: `ai/pipelines/pixel_voice/`
...
**Location**: `ai/pipelines/dual_persona_training/`
...
**Solution**:
Check if the Pixel Voice pipeline has been run and data exists in `ai/pipelines/pixel_voice/`
...
```bash
cd ai/pipelines/edge_case_pipeline_standalone/output/
...
- **Edge Case Pipeline**: `ai/pipelines/edge_case_pipeline_standalone/README.md`
- **Pixel Voice Pipeline**: `ai/pipelines/pixel_voice/DEPLOYMENT.md`
...
**Questions?** Check the troubleshooting section or review the source code in `ai/dataset_pipeline/orchestration/integrated_training_pipeline.py`
