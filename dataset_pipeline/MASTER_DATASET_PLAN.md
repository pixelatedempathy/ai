...
- Filter rules in `ai/data/master_dataset_manifest.json`:
...
**Datasets:**
- Priority datasets (Tier 1): `priority_1_FINAL.jsonl`, `priority_2_FINAL.jsonl`, `priority_3_FINAL.jsonl`
...
- Google Drive: Check `ai/data/master_dataset_manifest.json` for `gdrive_path` references
...
5. **Updated Manifests**:
   - `ai/data/master_dataset_manifest.json` - Updated with S3 paths
