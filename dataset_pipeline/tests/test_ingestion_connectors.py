...
@patch('ai.dataset_pipeline.youtube_connector.subprocess.run')
@patch('ai.dataset_pipeline.youtube_processor.YouTubePlaylistProcessor')
...
@patch('ai.dataset_pipeline.s3_connector.boto3.Session')
...
@patch('ai.dataset_pipeline.gcs_connector.storage.Client')
...
class TestConnectorIntegration:
    ...
    def test_local_connector_with_deduplication(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from ai.dataset_pipeline.ingestion_deduplication import get_ingestion_deduplicator
