...
class TestInteractiveMode:
    ...
    @patch("click.prompt")
    def test_prompt_for_session_config(self, mock_prompt):
        """Test prompting for session configuration."""
        mock_prompt.side_effect = [
            "pubmed,zenodo",  # target_sources
            "therapy:cbt,dbt",  # search_keywords
            "10",  # sources_identified target
            "5",  # datasets_evaluated target
        ]
    ...
    def test_interactive_mode_handles_cancellation(self):
