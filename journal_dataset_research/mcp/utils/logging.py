...
from ai.journal_dataset_research.mcp.config import LoggingConfig
...
def setup_logging(config: LoggingConfig) -> None:
    ...
    mcp_logger = logging.getLogger("ai.journal_dataset_research.mcp")
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    """
    if name:
        return logging.getLogger(f"ai.journal_dataset_research.mcp.{name}")
    return logging.getLogger("ai.journal_dataset_research.mcp")
