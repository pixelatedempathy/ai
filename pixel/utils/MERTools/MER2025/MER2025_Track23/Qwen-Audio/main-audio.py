...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", default="xxx", help="evaluate dataset"
    )  # dataset can set to "hybird"
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        config.PATH_TO_MLLM["qwen-audio-chat"], trust_remote_code=True
    )
    model = AutoModelForCausalLM.from_pretrained(
        config.PATH_TO_MLLM["qwen-audio-chat"], device_map="cuda", trust_remote_code=True
    ).eval()
