...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(
        self, data_path: str, tokenizer: transformers.PreTrainedTokenizer, multimodal_cfg: dict
    ):
...
def train():
    ...
    model.config.mm_use_vid_start_end = data_args.mm_use_vid_start_end = (
        model_args.mm_use_vid_start_end
    )
    vision_config.use_vid_start_end = training_args.use_vid_start_end = (
        model_args.mm_use_vid_start_end
    )
