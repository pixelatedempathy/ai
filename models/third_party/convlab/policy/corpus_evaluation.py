...
def arg_parser():
    ...
    parser.add_argument("--model", "-m", type=str, default="DDPT", help="name of model")
    parser.add_argument("--config", "-c", type=str, default="", help="model config")
    parser.add_argument("--weight", "-w", type=str, default="", help="model weight")
    parser.add_argument("--pipeline", "-p", type=str, default="", help="system pipeline")
...
def generate_dialog(system, dialog):
    ...
    for turn in dialog["turns"]:
        if turn["speaker"] == "user":
            ...
            sys_utt = nlg.generate(action, conduct, user_utt)
