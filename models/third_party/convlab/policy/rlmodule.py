...
class EpsilonGreedyPolicy(nn.Module):
    def __init__(
        self, s_dim, h_dim, a_dim, epsilon_spec={"start": 0.1, "end": 0.0, "end_epoch": 200}
    ):
...
Transition_evaluator = namedtuple(
...
Transition = namedtuple(
    "Transition", ("state", "action", "reward", "next_state", "mask", "action_mask")
)
