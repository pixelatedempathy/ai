...
def selected_models_for_videomae(out_file, model_root, save_root, model_name="videomae-base"):
    ...
    if model_name == "videomae-base":
        processor_path = os.path.join(
            config.PATH_TO_PRETRAINED_MODELS, "transformers/videomae-base/preprocessor_config.json"
        )
    elif model_name == "videomae-large":
        processor_path = os.path.join(
            config.PATH_TO_PRETRAINED_MODELS, "transformers/videomae-large/preprocessor_config.json"
        )
