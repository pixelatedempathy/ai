...
parser.add_argument(
    "--checkpoint_path", type=str, default=project_path + "checkpoint/" + time_str + "model.pth"
)
parser.add_argument(
    "--best_checkpoint_path",
    type=str,
    default=project_path + "checkpoint/" + time_str + "model_best.pth",
)
parser.add_argument(
...
parser.add_argument(
    "--resume", default=checkpoint_path, type=str, metavar="PATH", help="path to checkpoint"
)
parser.add_argument(
    "-e", "--evaluate", default=False, action="store_true", help="evaluate model on test set"
)
parser.add_argument("--beta", type=float, default=0.6)
parser.add_argument("--gpu", type=str, default="0")
parser.add_argument(
    "--scratch", default=False, action="store_true", help="train model from scratch"
)
...
def main():
    ...
    test_dataset = datasets.ImageFolder(
        valdir, transforms.Compose([transforms.Resize((224, 224)), transforms.ToTensor()])
    )
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        loss = (args.beta * criterion(output1, target)) + (
            (1 - args.beta) * criterion(output2, target)
        )
