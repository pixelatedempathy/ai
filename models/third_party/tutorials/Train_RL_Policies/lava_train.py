...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--episode_num", type=int, default=100, help="number of episode sampled per epoch"
    )
    ...
    parser.add_argument(
        "--lava_model_type", type=str, default="actz_cat", help="which LAVA variant to choose"
    )
    parser.add_argument(
        "--lex_type",
        type=str,
    ...
    model_path["ptS_cat"] = (
        "2020-02-26-18-11-37-sl_cat_ae/rgft-2020-10-13-15-07-56/rl-2020-10-13-16-40-58"
    )
    model_path["ptA_cat"] = (
        "2020-02-26-18-11-37-sl_cat_ae/rgft-2020-03-06-16-23-12/rl-2020-03-17-22-56-19"
    )
    model_path["ptS_gauss"] = (
        "2020-02-28-16-49-48-sl_gauss_ae/rgft-2020-03-11-16-20-07/rl-2020-03-18-15-31-56"
    )
    model_path["ptA_gauss"] = (
        "2020-02-28-16-49-48-sl_gauss_ae/rgft-2020-04-20-12-38-57/rl-2020-04-21-08-34-05"
    )
    ...
    lava_path = "/gpfs/project/lubis/NeuralDialog-LaRL/experiments_woz/sys_config_log_model/{}/reward_best.model".format(
