...
class MplugOwlProcessor(ProcessorMixin):
    ...
    def __call__(
        self, text=None, images=None, videos=None, num_frames=4, return_tensors=None, **kwargs
    ):
        ...
        if videos is not None:
            ...
            for video in videos:
                ...
                video_feature = self.image_processor(
                    video_frames, return_tensors=return_tensors, **kwargs
                )["pixel_values"]
        ...
        if text is not None and videos is not None:
            ...
            return BatchEncoding(
                data=dict(video_pixel_values=video_pixel_values), tensor_type=return_tensors
            )
