...
def func_find_all_chars(sentence):
    for _char in sentence:
        if (
            not is_chinese_character(_char)
            and not is_chinese_punc(_char)
            and not is_english_character(_char)
            and not is_english_punc(_char)
            and not is_digit(_char)
            and not is_space(_char)
            and not is_nextline(_char)
        ):
            print(_char)
