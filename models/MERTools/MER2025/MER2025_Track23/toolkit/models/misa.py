...
class MISA(nn.Module):
    def __init__(self, args):
        ...
        self.project_t.add_module(
            "project_t", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        ...
        self.project_v.add_module(
            "project_v", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        ...
        self.project_a.add_module(
            "project_a", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        ...
        self.private_t.add_module(
            "private_t_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        self.private_t.add_module("private_t_activation_1", nn.Sigmoid())

        self.private_v = nn.Sequential()
        self.private_v.add_module(
            "private_v_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        self.private_v.add_module("private_v_activation_1", nn.Sigmoid())

        self.private_a = nn.Sequential()
        self.private_a.add_module(
            "private_a_3", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        ...
        self.shared.add_module(
            "shared_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        ...
        self.recon_t.add_module(
            "recon_t_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        self.recon_v = nn.Sequential()
        self.recon_v.add_module(
            "recon_v_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )
        self.recon_a = nn.Sequential()
        self.recon_a.add_module(
            "recon_a_1", nn.Linear(in_features=hidden_dim, out_features=hidden_dim)
        )

        # fusion + cls
        self.fusion = nn.Sequential()
        self.fusion.add_module(
            "fusion_layer_1", nn.Linear(in_features=hidden_dim * 6, out_features=hidden_dim * 3)
        )
        self.fusion.add_module("fusion_layer_1_dropout", nn.Dropout(dropout))
        self.fusion.add_module("fusion_layer_1_activation", nn.ReLU())
        self.fusion.add_module(
            "fusion_layer_3", nn.Linear(in_features=hidden_dim * 3, out_features=output_dim)
        )
    ...
    def forward(self, batch):
        ...
        interloss = (
            self.diff_weight * self.get_diff_loss()
